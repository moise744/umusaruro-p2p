...
class _MyProjectsScreenState extends ConsumerState<MyProjectsScreen>
  ...
  List<MockProject> _filtered(String status) {
    if (status == 'all') return mockProjects;
    return mockProjects.where((p) => p.status == status).toList();
  }
    ...
    return Scaffold(
      ...
      body: OfflineBanner(
        child: TabBarView(
          controller: _tabController,
          children: [
            _ProjectList(projects: _filtered('all')),
            _ProjectList(projects: _filtered('active')),
            _ProjectList(projects: _filtered('completed')),
          ],
        ),
      ),
    );
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _Stat(label: 'Duration', value: '${project.durationMonths}mo'),
